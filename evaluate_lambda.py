...
def main():
    ...
    ckpt_filename = f'~/local/workdir/{args.model}/checkpoints/checkpoint.pth'
    ...
    if False: #args.lam == 1:
        ...
        pc_fouriercs = get_jalal_sampling_lambda(sde,
                                               predictor, corrector,
                                               inverse_scaler,
                                               snr=snr,
                                               n_steps=m,
